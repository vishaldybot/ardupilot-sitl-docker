...
`docker build --tag ardupilot --build-arg COPTER_TAG=Copter-4.0.1 github.com/radarku/ardupilot-sitl-docker](https://github.com/vishaldybot/ardupilot-sitl-docker.git`
